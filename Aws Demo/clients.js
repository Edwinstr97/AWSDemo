const { awsCsfleHelper } = require("./kms");
const kms = require("./kms");
require("dotenv").config();

// const kmsClient = kms.localCsfleHelper();
const kmsClient = kms.awsCsfleHelper();

async function main(regularClient, csfleClient) {
  try {
    let dataKey = "2sWHVoZTiStC2/Su5iVMA=="; // change this to the base64 encoded data key generated from make-data-key.js
    if (dataKey === null) {
